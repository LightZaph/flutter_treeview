  ...
  static Color getColor(String value) {
    ...
    if (_hexExp.hasMatch(colorValue)) {
      ...
      if (colorValue.length == 3 || colorValue.length == 4) {
        ...
        List<String> pieces = colorValue
            .split('')
            .map((String piece) => '$piece$piece')
            .toList();
      ...
      switch (value) {
        ...
        case 'amberAccent50':
          return Colors.amberAccent.withOpacity(0.2);
        case 'amberAccent100':
        ...
        case 'lightGreenAccent50':
          return Colors.lightGreenAccent.withOpacity(0.2);
        ...
        case 'limeAccent50':
          return Colors.limeAccent.withOpacity(0.2);
        case 'limeAccent100':
